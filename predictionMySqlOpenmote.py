...
def main(argv):
    ...
    st10, t10 = readStartTime2(cursor, TABLE, 0, stmax + 20000)
    st11, t11 = readStartTime2(cursor, TABLE, 1, stmax + 20000)
    st12, t12 = readStartTime2(cursor, TABLE, 2, stmax + 20000)
    st13, t13 = readStartTime2(cursor, TABLE, 3, stmax + 20000)
    st14, t14 = readStartTime2(cursor, TABLE, 4, stmax + 20000)
